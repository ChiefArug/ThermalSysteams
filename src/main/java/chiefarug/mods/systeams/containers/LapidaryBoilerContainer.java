...
public class LapidaryBoilerContainer extends BoilerContainerBase<LapidaryBoilerBlockEntity> {

	public LapidaryBoilerContainer(int windowId, Inventory inv, FriendlyByteBuf data) {
		this(windowId, ProxyUtils.getClientWorld(), data.readBlockPos(), inv, ProxyUtils.getClientPlayer());
	}

	public LapidaryBoilerContainer(int windowId, Level level, BlockPos pos, Inventory inventory, Player player) {
