...
public class NumismaticBoilerMenu extends BoilerMenuBase<NumismaticBoilerBlockEntity> {
	public NumismaticBoilerMenu(int windowId, Inventory inv, FriendlyByteBuf data) {
		this(windowId, ProxyUtils.getClientWorld(), data.readBlockPos(), inv, ProxyUtils.getClientPlayer());
	}

	public NumismaticBoilerMenu(int windowId, Level level, BlockPos pos, Inventory inventory, Player player) {
