...
public class DisenchantmentBoilerMenu extends BoilerMenuBase<DisenchantmentBoilerBlockEntity> {

	public DisenchantmentBoilerMenu(int windowId, Inventory inv, FriendlyByteBuf data) {
		this(windowId, ProxyUtils.getClientWorld(), data.readBlockPos(), inv, ProxyUtils.getClientPlayer());
	}

	public DisenchantmentBoilerMenu(int windowId, Level level, BlockPos pos, Inventory inventory, Player player) {
